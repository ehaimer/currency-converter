...
function CurrencyConverterApp() {
  ...
  const apiKey = "fca_live_xyKVzjJtnxqhivW9Fj644gOCFs4ZMBbUnagN0ubK"
  ...
  const handleEnter = async (e) => {
    ...
    if (
      ...
      if (!isNaN(topValueAmount)) {
        setBottomValue(
          (filteredData[bottomCountry] * topValueAmount).toFixed(2)
        )
      } else {
        setTopValue((filteredData[topCountry] * bottomValueAmount).toFixed(2))
      }
    }
  }
